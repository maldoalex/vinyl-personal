...
// import React from "react";
// import CustomButton from "../CustomButton/CustomButton";
// import { register } from "../../redux/user/user.reducer";
// import axios from "axios";
// import "./Register.scss";
...
//   handleSubmit = event => {
//     const { first_name, last_name, display_name, email, password } = this.state;
//     this.props.register(first_name, last_name, display_name, email, password);
...
//   //use key 'name' to set state for respective key
//   render() {
//     const { first_name, last_name, display_name, email, password } = this.props;
//     return (
//       <div className="register">
//         <h2 className="title">Create an account</h2>
//         <span>Please fill out form</span>
